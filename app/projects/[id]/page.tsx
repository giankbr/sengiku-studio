        ...
        <div className="container mx-auto px-4">
          ...
          <div className="fade-in max-w-3xl mx-auto text-center">
            ...
            <Link
              ...
              className="text-2xl font-bold hover:text-primary transition-colors inline-flex items-center"
            >
          ...
          <div className="fade-in mt-20 py-12 px-8 bg-muted dark:bg-zinc-900 rounded-lg text-center max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground mb-6">
              Let's discuss how we can help bring your project to life with our creative expertise.
            </p>
